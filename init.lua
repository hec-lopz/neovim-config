...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        if disable_filetypes[vim.bo[bufnr].filetype] or vim.g.disable_autoformat or vim.b.disable_autoformat then
          return nil
        else
          return {
            timeout_ms = 500,
      ...
      formatters_by_ft = {
        ...
        json = { 'fixjson', 'jsonls', stop_after_first = true },
      },
    },
  ...
  lockfile = './lazy-lock.json', -- lockfile generated after running update.
})
